...
export function ScoreButton({
	...
	return (
		<button
			onClick={onClick}
			className="px-4 py-3 bg-button-primary cursor-pointer hover:bg-button-primary-hover text-button-primary-text font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-sm whitespace-nowrap"
			type="button"
		>
